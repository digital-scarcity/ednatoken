...
cleos push action ednatoken2 addstake '["staker1", 1, "200000000.0000 EDNA"]' -p staker1
cleos push action ednatoken2 addstake '["staker2", 1, "66663666.0000 EDNA"]' -p staker2
cleos push action ednatoken2 addstake '["staker3", 1, "88882388.0000 EDNA"]' -p staker3
cleos push action ednatoken2 addstake '["staker4", 1, "200000000.0000 EDNA"]' -p staker4
